...
namespace ElectronicObserver.Data {
    ...
    public class EquipmentDataMaster : ResponseWrapper, IIdentifiable {
        ...
        public ReadOnlyCollection<int> EquipmentType {
            get { return new ReadOnlyCollection<int>((int[])RawData.api_type); }
        }
        ...
        public ReadOnlyCollection<int> Material {
            get { return new ReadOnlyCollection<int>((int[])RawData.api_broken); }
        }
        ...
        public int AircraftCost {
            get {
                ...
                try { return (int)RawData.api_cost; } catch (Exception) { return 0; }
            }
        }
        ...
        public int AircraftDistance {
            get {
                ...
                try { return (int)RawData.api_distance; } catch (Exception) { return 0; }
            }
        }
